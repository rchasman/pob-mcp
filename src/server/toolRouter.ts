...
export async function routeToolCall(
  ...
  switch (name) {
    ...
    case "lua_import_code":
      if (!args) throw new Error("Missing arguments");
      return await handleLuaImportCode(
        luaContext,
        args.code as string,
        args.name as string | undefined
      );
